...
// The grammar reconciliation model below remains private until the public
// syntax switch. It intentionally coexists with the line-CST shape above only
// as transaction staging; no public or HIR reader can observe it.

...
pub use expression::{
    ...
    AttachedCandidateKeywordStatement, AttachedCandidateLetElse, AttachedCandidateMatch,
    AttachedCandidateMatchArm, AttachedCandidateMatchArmBody, AttachedCandidateMatchArmStatement,
    AttachedCandidateMatchBody, AttachedCandidateMatchStatement, AttachedCandidateNode,
    AttachedCandidateNominalTypeRoot, AttachedCandidatePathExpression,
    AttachedCandidatePathProjection, AttachedCandidatePathSegment, AttachedCandidatePatternChild,
    AttachedCandidatePatternProjection, AttachedCandidateRequiredOperand,

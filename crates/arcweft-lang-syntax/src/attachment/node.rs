...
define_ast_kinds!(EXPRESSION_MARKERS, Expression;
    ...
    AttachedContentApplicationExpressionKind => AttachedContentApplicationExpression,
    ...
    LoopExpressionKind => LoopExpression,
...
define_ast_kinds!(RICH_TEXT_MARKERS, RichText;
    DialoguePointActionKind => DialoguePointAction,
    DialoguePointActionNameKind => DialoguePointActionName,
    DialogueActionArgumentPayloadKind => DialogueActionArgumentPayload,
    DialogueActionTimedCuePayloadKind => DialogueActionTimedCuePayload,
    DialogueActionFxCallPayloadKind => DialogueActionFxCallPayload,
    DialogueActionDialogueCallPayloadKind => DialogueActionDialogueCallPayload,
    DialogueActionConditionPayloadKind => DialogueActionConditionPayload,
    DialogueActionPositionalArgumentKind => DialogueActionPositionalArgument,
    DialogueActionNamedArgumentKind => DialogueActionNamedArgument,
    DialogueActionInvalidArgumentKind => DialogueActionInvalidArgument,
    DialogueActionArgumentKeyKind => DialogueActionArgumentKey,
    DialogueActionArgumentEqualsKind => DialogueActionArgumentEquals,
    DialogueActionArgumentValueKind => DialogueActionArgumentValue,
    DialogueActionArgumentTokenKind => DialogueActionArgumentToken,
    DialogueActionArgumentContentKind => DialogueActionArgumentContent,
    DialogueActionArgumentQuoteKind => DialogueActionArgumentQuote,
    DialogueActionMissingArgumentValueKind => DialogueActionMissingArgumentValue,
    DialogueActionInvalidArgumentIssueKind => DialogueActionInvalidArgumentIssue,
);
...
define_ast_kinds!(DECLARATION_PART_MARKERS, DeclarationPart;
    ...
    AttachedContentParameterKind => AttachedContentParameter,
    AttachedContentRoleKind => AttachedContentRole,
    ...
    CharacterDisplayMemberKind => CharacterDisplayMember,

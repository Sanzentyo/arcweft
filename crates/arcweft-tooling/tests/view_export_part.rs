use arcweft_tooling::{edit::apply_text_edits, format::format_source, model::FormatOptions};
...
fn canonicalizes_valid_export_and_local_part_without_reordering() {
    ...
    let repeated = format_source(&report.output, FormatOptions::default()).expect("second format");

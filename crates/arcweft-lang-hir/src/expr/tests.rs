...
fn edge_role_tag(role: &HirExpressionChildRole) -> u8 {
    match role {
        ...
        HirExpressionChildRole::ChoiceIfCondition { .. } => 37,
        HirExpressionChildRole::ChoiceForSource { .. } => 38,
        HirExpressionChildRole::ChoiceMatchScrutinee { .. } => 39,
        HirExpressionChildRole::ChoiceMatchGuard { .. } => 40,
        HirExpressionChildRole::ChoiceOptionId { .. } => 41,
        HirExpressionChildRole::ChoiceOptionForSource { .. } => 42,
        HirExpressionChildRole::ChoiceCompactLabel { .. } => 43,
        HirExpressionChildRole::ChoiceCompactCondition { .. } => 44,
        HirExpressionChildRole::ChoiceCompactOut { .. } => 45,
        HirExpressionChildRole::ChoiceOptionLabel { .. } => 46,
        HirExpressionChildRole::ChoiceOptionFieldId { .. } => 47,
        HirExpressionChildRole::ChoiceOptionValue { .. } => 48,
        HirExpressionChildRole::ChoiceOptionVisible { .. } => 49,
        HirExpressionChildRole::ChoiceOptionEnabled { .. } => 50,
        HirExpressionChildRole::ChoiceOptionOrder { .. } => 51,
        HirExpressionChildRole::ChoiceOptionHotkey { .. } => 52,
        HirExpressionChildRole::ChoiceOptionViewKey { .. } => 53,
        HirExpressionChildRole::ChoiceOptionViewValue { .. } => 54,
        HirExpressionChildRole::ChoicePlanAssignment { .. } => 55,
        HirExpressionChildRole::ChoicePlanTimeout { .. } => 56,
        HirExpressionChildRole::ChoicePlanCancelSignal { .. } => 57,
        HirExpressionChildRole::ChoicePlanCancelTimeout { .. } => 58,
        HirExpressionChildRole::ChoicePlanCancelExpr { .. } => 59,
    }
}

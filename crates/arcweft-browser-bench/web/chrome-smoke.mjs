...
function summarize(report) {
  ...
  return {
    ...
    selected_modes: (report.recommendations ?? []).slice(0, 8).map((entry) => ({
      ...
      selected_median_ms: entry.selected_median_ms,
      selected_mad_ms: entry.selected_mad_ms,
      selected_p95_ms: entry.selected_p95_ms,
      cpu_median_ms: entry.cpu_median_ms,
      cpu_mad_ms: entry.cpu_mad_ms,
      cpu_p95_ms: entry.cpu_p95_ms,

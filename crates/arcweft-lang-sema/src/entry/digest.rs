...
const fn canonical_constructor_tag(constructor: CanonicalConstructor) -> u8 {
    match constructor {
        ...
        CanonicalConstructor::ArcResult => 9,
        CanonicalConstructor::Option => 10,
        CanonicalConstructor::Need => 11,
        CanonicalConstructor::Stream => 12,
        CanonicalConstructor::Source => 13,
        CanonicalConstructor::Reduction => 14,
        CanonicalConstructor::Speaker => 15,
        CanonicalConstructor::SpeakerPreset => 16,
        CanonicalConstructor::Ref => 17,
        CanonicalConstructor::Probe => 18,
        CanonicalConstructor::ThreadHandle => 19,
        CanonicalConstructor::Shared => 20,
    }
}

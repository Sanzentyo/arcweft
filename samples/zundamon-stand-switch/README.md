...
For the browser player, copy the generated bundle to ignored `web/local/` and
open `web/index.html?bundle=./local/zundamon-stand-switch.awfb` after the normal
wasm build step. The bundle copy under `web/local/` is ignored.

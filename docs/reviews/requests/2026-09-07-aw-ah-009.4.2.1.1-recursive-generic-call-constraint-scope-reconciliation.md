...
- Current reconciliation: [AW-AH-009.4.2.1.1.1](2026-09-08-aw-ah-009.4.2.1.1.1-function-scheme-specialization-and-callable-value-execution.md)
  reopens function-scheme use and its connection to ordinary callable-value
  execution under the current convergence goal. The returned archive remains
  frozen; its published-prefix restriction is not an adjudicated completion
  of that goal.

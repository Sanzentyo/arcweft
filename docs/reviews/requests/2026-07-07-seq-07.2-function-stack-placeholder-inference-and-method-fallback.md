...
4. Method-chain fallback uses typed callable evidence for positional data-last
   ...
   candidates now produce structured unsupported diagnostics; executable
   named/spread fallback lowering, curried call-group runtime metadata, and
   real-method-versus-fallback ambiguity diagnostics remain open.

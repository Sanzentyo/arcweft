...
use validation_support::{
    DESIGN_REL, load_bundle, validate_manifest, validate_repository, validate_semantic,
    write_manifest,
};
...
fn run() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        "PASS design={} files={} statement_rows=35 trigger_tags=9 payload_tags=15 repository={}",
        bundle.root.display(),
        bundle.files.len(),

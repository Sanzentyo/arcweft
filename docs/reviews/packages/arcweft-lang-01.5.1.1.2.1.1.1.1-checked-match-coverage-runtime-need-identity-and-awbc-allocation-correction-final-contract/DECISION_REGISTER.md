...
| Required exact decision | Subject | Final resolution | Normative artifact |
|---:|---|---|---|
...
There are no unresolved selections, implementation-defined identity fields, or
compatibility choices. Every row is machine-traced in

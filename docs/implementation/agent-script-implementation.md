...
- Type Agent references against actions and deeper resource/body field shapes beyond the current choice/layer/signal/metric plus typed inline image-action project-index coverage and typed `read_resource(...) -> AgentResource` metadata fields.

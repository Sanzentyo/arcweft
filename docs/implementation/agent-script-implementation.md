...
- Extend `.arcwx` beyond CLI run trace writing, validation, read-only logical replay, Sans-I/O MCP resource conversion, and stdio MCP trace file loading/resources: add native game-adapter trace capture and trace validation for captured blobs.

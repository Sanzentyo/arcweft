...
- Add privacy classification enforcement, byte-backed blob directory lifecycle integration, and CLI/MCP debug commands beyond DB maintenance and current MCP state/signal/log/RAG reads.

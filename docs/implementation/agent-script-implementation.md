...
- Extend privacy classification enforcement beyond current CLI/MCP RAG context filtering and debug lexical search into product-mode resource redaction, audit logging, persistence policy, and non-RAG/non-search debug reads.

...
- Extend `.arcwx` beyond CLI run trace writing, validation, and read-only logical replay: add MCP trace resources, native game-adapter trace capture, and trace validation for captured blobs.

...
- Execute `expect(...)` / `deny(...)` through structured assertion failure semantics in the shared Agent runner instead of leaving effect-form assertion calls unsupported at runtime.

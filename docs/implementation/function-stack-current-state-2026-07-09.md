...
- Current closure-effect composition for the broad implemented closure,
  ...
  `await` boundary, partial-closure timing and `no_effect` invocation
  coverage, and a closed-row report projection consumed by Agent

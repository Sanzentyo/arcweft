...
- Current closure-effect composition for the broad implemented closure,
  ...
  through a typed `ClosedEffectRowReport` boundary. LSP callable declaration
  hover also consumes that closed boundary for current inferred/upper-bound/
  forbidden row display.

...
- Current closure-effect composition for the broad implemented closure,
  ...
  directly to compiler/LSP consumers. LSP callable declaration hover also
  consumes that closed boundary for current inferred/upper-bound/forbidden row
  display.

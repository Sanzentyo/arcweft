# Historical test execution profiling and detailed command record

This document preserves the profiling and detailed command record that informed
Arcweft's test policy from 2026-06-12 through 2026-07-10. The current concise
selection authority is `../test-execution-policy.md`.

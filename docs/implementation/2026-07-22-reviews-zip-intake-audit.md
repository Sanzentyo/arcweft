...
| [`arcweft-lang-01.3.1.2.2.1-curried-stream-wire-allocation-reconciliation-final-contract.zip`](../reviews/packages/arcweft-lang-01.3.1.2.2.1-curried-stream-wire-allocation-reconciliation-final-contract.zip) | `8ADED7B1CB5D92F9D820C2CC82121AC6D070F3CF26D1618DC23FF144081090AD` | Received, fully verified, and implementation-ready at the Lang-01.3 dependency position | Use `0x27 OpenStream`, `0x28 FinishStream`, and `0x29 ApplyExternalStreamGroup`; replace the flat callable/function/argument/wire owners in place and delete old codec/Source readers at the prescribed atomic switches. No correction request remains. |
| [`arcweft-lang-01.1.1.3-effect-trait-contract-and-dynamic-dispatch-production-reconciliation-final-contract.zip`](../reviews/packages/arcweft-lang-01.1.1.3-effect-trait-contract-and-dynamic-dispatch-production-reconciliation-final-contract.zip) | `4FD834564C458639CD4EBE46615E4EC79C54F91D686439AAAACCC7F2B3714B5E` | Mechanically valid; catalog authority correction required | Retain its E017 supersession, typed trait-effect semantics/diagnostics, and deletion inventory, but do not implement its copied signature/source facts until Lang-01.1.1.3.1 selects one exact relationship with the existing accepted callable catalog. |
| [`arcweft-lang-01.1.1.3.1-checked-callable-catalog-authority-and-consumer-scope-reconciliation-final-contract.zip`](../reviews/packages/arcweft-lang-01.1.1.3.1-checked-callable-catalog-authority-and-consumer-scope-reconciliation-final-contract.zip) | `0E4746ABD1589F0228ADC62A074DFC07EEC92F3DF4DBC432E58138FD21500F4C` | Catalog authority accepted; narrow trait-validator identity correction required | Retain its exact accepted-record Arc, checked-catalog, consumer, transaction, and deletion decisions. Before deleting `TraitCallableId`, obtain Lang-01.1.1.3.1.1 for the pre-check validator payload and `CallableFamily::TraitMethod` projection. The archive has 12 total members/11 valid non-self manifest rows; its “12 non-self” prose is a nonblocking count typo. |
...
One request is ready to dispatch now:
...
Send it with the returned Lang-01.1.1.3.1 ZIP. It is limited to selecting the
typed pre-check validator payload after `TraitCallableId` deletion and the
trait-method observational family projection used by resolver accounting and
signature help. It must not reopen the exact accepted-record Arc model, E017S,
effect-row semantics, consumer scope, or ordinary-call resolution.

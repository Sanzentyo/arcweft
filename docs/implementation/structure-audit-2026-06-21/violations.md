...
## warning TYPE001 — `crates/arcweft-agent-protocol/src/artifact.rs:24`
...
1221 physical LOC exceeds the 1200 LOC review threshold
...
1439 physical LOC exceeds the 1200 LOC review threshold
...
5633 physical LOC exceeds the 2500 LOC review threshold
...
2427 physical LOC exceeds the 1200 LOC review threshold
...
1707 physical LOC exceeds the 1200 LOC review threshold
...
1626 physical LOC exceeds the 1200 LOC review threshold
...
1514 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE002 — `crates/arcweft-render-native/src/lib.rs`

facade file has 1514 physical LOC; target is below 250 LOC
...
4395 physical LOC exceeds the 2500 LOC review threshold
...
2155 physical LOC exceeds the 1200 LOC review threshold
...
1274 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE002 — `crates/arcweft-runtime-accelerator/src/lib.rs`

facade file has 1274 physical LOC; target is below 250 LOC
...
2472 physical LOC exceeds the 1200 LOC review threshold
...
1372 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE002 — `crates/arcweft-verify-lsp/src/lib.rs`

facade file has 1372 physical LOC; target is below 250 LOC
...
1686 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE002 — `crates/arcweft-verify/src/lib.rs`

facade file has 1686 physical LOC; target is below 250 LOC

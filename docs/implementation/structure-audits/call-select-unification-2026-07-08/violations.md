...
2590 physical LOC exceeds the 2500 LOC error threshold
...
## warning SIZE001 — `crates/arcweft-bundle/src/resource_codec/ui/codec.rs`

1317 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-bundle/src/resource_codec/ui/model.rs`

2097 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning TEST001 — `crates/arcweft-bundle/src/resource_codec/ui/model.rs`

large production file contains an embedded #[cfg(test)] module

**Fix:** move tests to domain-specific child test modules or integration tests

## warning SIZE001 — `crates/arcweft-bundle/src/resource_codec/ui/runtime_control_style.rs`

2055 physical LOC exceeds the 1200 LOC review threshold
...
3657 physical LOC exceeds the 2500 LOC review threshold
...
2266 physical LOC exceeds the 1200 LOC review threshold
...
2678 physical LOC exceeds the 2500 LOC review threshold
...
1461 physical LOC exceeds the 1200 LOC review threshold
...
2050 physical LOC exceeds the 1200 LOC review threshold
...
facade file has 1241 physical LOC; target is below 250 LOC
...
2258 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-lang-sema/src/checker/expr.rs`

2399 physical LOC exceeds the 1200 LOC review threshold
...
1858 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-lang-sema/src/semantic.rs`

2031 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-lang-sema/src/tests/function_stack.rs`

2837 physical LOC exceeds the 2500 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-lang-sema/src/tests/typecheck.rs`

2501 physical LOC exceeds the 2500 LOC review threshold
...
2075 physical LOC exceeds the 1200 LOC review threshold
...
2309 physical LOC exceeds the 1200 LOC review threshold
...
2107 physical LOC exceeds the 1200 LOC review threshold
...
4450 physical LOC exceeds the 2500 LOC review threshold
...
1718 physical LOC exceeds the 1200 LOC review threshold
...
2126 physical LOC exceeds the 1200 LOC review threshold
...
1760 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-runtime-plan/src/awbc_lower/inventory.rs`

1251 physical LOC exceeds the 1200 LOC review threshold
...
2439 physical LOC exceeds the 1200 LOC review threshold
...
1456 physical LOC exceeds the 1200 LOC review threshold

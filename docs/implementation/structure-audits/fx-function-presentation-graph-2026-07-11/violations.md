...
1402 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-bundle/src/resource_codec/view/model.rs`

2278 physical LOC exceeds the 1200 LOC review threshold
...
2048 physical LOC exceeds the 1200 LOC review threshold
...
1403 physical LOC exceeds the 1200 LOC review threshold
...
3705 physical LOC exceeds the 2500 LOC review threshold
...
2301 physical LOC exceeds the 1200 LOC review threshold
...
2456 physical LOC exceeds the 1200 LOC review threshold
...
1986 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-lang-sema/src/env.rs`

1269 physical LOC exceeds the 1200 LOC review threshold
...
1568 physical LOC exceeds the 1200 LOC review threshold
...
1470 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-lsp/src/features/actions.rs`

1663 physical LOC exceeds the 1200 LOC review threshold
...
1268 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE002 — `crates/arcweft-render-native/src/lib.rs`

facade file has 1268 physical LOC; target is below 250 LOC
...
4096 physical LOC exceeds the 2500 LOC review threshold
...
facade file has 1745 physical LOC; target is below 250 LOC
...
2106 physical LOC exceeds the 1200 LOC review threshold
...
1878 physical LOC exceeds the 1200 LOC review threshold
...
facade file has 1040 physical LOC; target is below 250 LOC

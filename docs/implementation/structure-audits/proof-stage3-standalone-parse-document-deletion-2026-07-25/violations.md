...
## warning SIZE001 — `crates/arcweft-adapter-context/src/manifest/registration/input.rs`
...
3361 physical LOC exceeds the 2500 LOC review threshold
...
2765 physical LOC exceeds the 2500 LOC review threshold
...
7021 physical LOC exceeds the 2500 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-compiler/src/persistent.rs`

1426 physical LOC exceeds the 1200 LOC review threshold
...
3621 physical LOC exceeds the 2500 LOC review threshold
...
1639 physical LOC exceeds the 1200 LOC review threshold
...
2347 physical LOC exceeds the 1200 LOC review threshold
...
1702 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-lang-sema/src/checker/module.rs`

2134 physical LOC exceeds the 1200 LOC review threshold
...
3200 physical LOC exceeds the 2500 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-lang-sema/src/tests/typecheck.rs`

4471 physical LOC exceeds the 2500 LOC review threshold
...
1846 physical LOC exceeds the 1200 LOC review threshold
...
1873 physical LOC exceeds the 1200 LOC review threshold
...
1308 physical LOC exceeds the 1200 LOC review threshold
...
1341 physical LOC exceeds the 1200 LOC review threshold
...
2105 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-verify-lsp/src/lib.rs`

1940 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE002 — `crates/arcweft-verify-lsp/src/lib.rs`

facade file has 1940 physical LOC; target is below 250 LOC
...
1958 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE002 — `crates/arcweft-verify/src/lib.rs`

facade file has 1958 physical LOC; target is below 250 LOC

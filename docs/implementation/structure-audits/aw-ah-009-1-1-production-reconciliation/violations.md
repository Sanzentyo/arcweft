...
1418 physical LOC exceeds the 1200 LOC review threshold
...
2324 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-lang-sema/src/semantic.rs`

2032 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-lang-sema/src/tests/typecheck.rs`

4112 physical LOC exceeds the 2500 LOC review threshold
...
2235 physical LOC exceeds the 1200 LOC review threshold
...
1494 physical LOC exceeds the 1200 LOC review threshold
...
1921 physical LOC exceeds the 1200 LOC review threshold
...
1912 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE002 — `crates/arcweft-verify/src/lib.rs`

facade file has 1912 physical LOC; target is below 250 LOC

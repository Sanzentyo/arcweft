...
2162 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE002 — `crates/arcweft-bundle/src/lib.rs`

facade file has 2162 physical LOC; target is below 250 LOC
...
1914 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-bundle/src/resource_codec/view/model.rs`

2449 physical LOC exceeds the 1200 LOC review threshold
...
2317 physical LOC exceeds the 1200 LOC review threshold
...
2459 physical LOC exceeds the 1200 LOC review threshold
...
1545 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-lsp/src/features/actions.rs`

1489 physical LOC exceeds the 1200 LOC review threshold
...
1722 physical LOC exceeds the 1200 LOC review threshold
...
2100 physical LOC exceeds the 1200 LOC review threshold
...
2415 physical LOC exceeds the 1200 LOC review threshold

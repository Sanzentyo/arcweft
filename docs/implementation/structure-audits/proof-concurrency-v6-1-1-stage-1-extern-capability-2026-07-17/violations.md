...
1376 physical LOC exceeds the 1200 LOC review threshold
...
2196 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE002 — `crates/arcweft-bundle/src/lib.rs`

facade file has 2196 physical LOC; target is below 250 LOC
...
1492 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-bundle/src/resource_codec/view/model.rs`

1801 physical LOC exceeds the 1200 LOC review threshold
...
1898 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-cli/src/app/bundle.rs`

2027 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-cli/src/app/bundle/tests.rs`

2563 physical LOC exceeds the 2500 LOC review threshold
...
2316 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-cli/src/app/runtime/run.rs`

1335 physical LOC exceeds the 1200 LOC review threshold
...
1387 physical LOC exceeds the 1200 LOC review threshold
...
7970 physical LOC exceeds the 2500 LOC review threshold
...
5363 physical LOC exceeds the 2500 LOC review threshold
...
2436 physical LOC exceeds the 1200 LOC review threshold
...
1294 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-lang-sema/src/checker.rs`

1759 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-lang-sema/src/checker/expr.rs`

2486 physical LOC exceeds the 1200 LOC review threshold
...
## warning SIZE001 — `crates/arcweft-lang-sema/src/checker/helpers.rs`
...
2343 physical LOC exceeds the 1200 LOC review threshold
...
4175 physical LOC exceeds the 2500 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-lang-sema/src/traits.rs`

1932 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-lang-syntax/src/ast/items.rs`

1758 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-lang-syntax/src/ast/view.rs`

1807 physical LOC exceeds the 1200 LOC review threshold
...
1446 physical LOC exceeds the 1200 LOC review threshold
...
## warning SIZE001 — `crates/arcweft-lang-syntax/src/incremental.rs`

1270 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning TEST001 — `crates/arcweft-lang-syntax/src/incremental.rs`
...
1631 physical LOC exceeds the 1200 LOC review threshold
...
1736 physical LOC exceeds the 1200 LOC review threshold
...
1581 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-runtime-driver/tests/session.rs`

2932 physical LOC exceeds the 2500 LOC review threshold
...
2362 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-runtime-plan/src/flow.rs`

1976 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-runtime-plan/tests/runtime_plan.rs`

2521 physical LOC exceeds the 2500 LOC review threshold
...
facade file has 1899 physical LOC; target is below 250 LOC

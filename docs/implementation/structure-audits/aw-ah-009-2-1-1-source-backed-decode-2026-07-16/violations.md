...
1246 physical LOC exceeds the 1200 LOC review threshold
...
2364 physical LOC exceeds the 1200 LOC review threshold
...
2018 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-cli/src/app/bundle/tests.rs`

2545 physical LOC exceeds the 2500 LOC review threshold
...
2314 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-cli/src/app/runtime/run.rs`

1329 physical LOC exceeds the 1200 LOC review threshold
...
2495 physical LOC exceeds the 1200 LOC review threshold
...
2367 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-lang-sema/src/project_index/relations.rs`
...
4223 physical LOC exceeds the 2500 LOC review threshold
...
1230 physical LOC exceeds the 1200 LOC review threshold
...
1574 physical LOC exceeds the 1200 LOC review threshold
...
1495 physical LOC exceeds the 1200 LOC review threshold
...
1557 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-runtime-driver/tests/session.rs`

2692 physical LOC exceeds the 2500 LOC review threshold
...
2365 physical LOC exceeds the 1200 LOC review threshold
...
1944 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE002 — `crates/arcweft-verify/src/lib.rs`

facade file has 1944 physical LOC; target is below 250 LOC

...
7774 physical LOC exceeds the 2500 LOC upper ownership-review trigger; LOC alone is not a structural error
...
1427 physical LOC exceeds the 1200 LOC ownership-review trigger
...
3734 physical LOC exceeds the 2500 LOC upper ownership-review trigger; LOC alone is not a structural error
...
2865 physical LOC exceeds the 2500 LOC upper ownership-review trigger; LOC alone is not a structural error

**Disposition:** record the named owner and cohesive responsibility, then either decompose along state/dependency/test boundaries or add an explicit repository-visible cohesion justification

## review-trigger SIZE001 — `crates/arcweft-core/src/engine.rs`

2038 physical LOC exceeds the 1200 LOC ownership-review trigger
...
5327 physical LOC exceeds the 2500 LOC upper ownership-review trigger; LOC alone is not a structural error
...
2506 physical LOC exceeds the 2500 LOC upper ownership-review trigger; LOC alone is not a structural error

**Disposition:** record the named owner and cohesive responsibility, then either decompose along state/dependency/test boundaries or add an explicit repository-visible cohesion justification

## review-trigger SIZE001 — `crates/arcweft-core/src/plan/entry_inventory.rs`

1491 physical LOC exceeds the 1200 LOC ownership-review trigger
...
3768 physical LOC exceeds the 2500 LOC upper ownership-review trigger; LOC alone is not a structural error
...
1263 physical LOC exceeds the 1200 LOC ownership-review trigger
...
4500 physical LOC exceeds the 2500 LOC upper ownership-review trigger; LOC alone is not a structural error
...
2181 physical LOC exceeds the 1200 LOC ownership-review trigger

**Disposition:** name the owner and responsibility, then review state, dependency, API, and test cohesion before adding more code

## review-trigger TEST001 — `crates/arcweft-lang-sema/src/callable/constraints.rs`

large maintained owner contains 1313 physical LOC of embedded test module source; source layout alone is not a blocking test-coupling finding
...
1858 physical LOC exceeds the 1200 LOC ownership-review trigger

**Disposition:** name the owner and responsibility, then review state, dependency, API, and test cohesion before adding more code

## review-trigger SIZE001 — `crates/arcweft-lang-sema/src/callable/join.rs`

1729 physical LOC exceeds the 1200 LOC ownership-review trigger
...
1639 physical LOC exceeds the 1200 LOC ownership-review trigger

**Disposition:** name the owner and responsibility, then review state, dependency, API, and test cohesion before adding more code

## review-trigger SIZE001 — `crates/arcweft-lang-sema/src/callable/resolver/outcome.rs`

1523 physical LOC exceeds the 1200 LOC ownership-review trigger

**Disposition:** name the owner and responsibility, then review state, dependency, API, and test cohesion before adding more code

## review-trigger SIZE001 — `crates/arcweft-lang-sema/src/callable/schema.rs`

4239 physical LOC exceeds the 2500 LOC upper ownership-review trigger; LOC alone is not a structural error

**Disposition:** record the named owner and cohesive responsibility, then either decompose along state/dependency/test boundaries or add an explicit repository-visible cohesion justification

## review-trigger TEST001 — `crates/arcweft-lang-sema/src/callable/schema.rs`

large maintained owner contains 1075 physical LOC of embedded test module source; source layout alone is not a blocking test-coupling finding
...
1666 physical LOC exceeds the 1200 LOC ownership-review trigger
...
1999 physical LOC exceeds the 1200 LOC ownership-review trigger
...
1714 physical LOC exceeds the 1200 LOC ownership-review trigger

**Disposition:** name the owner and responsibility, then review state, dependency, API, and test cohesion before adding more code

## review-trigger SIZE001 — `crates/arcweft-lang-sema/src/final_analysis/analyzer/call_seal.rs`

1957 physical LOC exceeds the 1200 LOC ownership-review trigger

**Disposition:** name the owner and responsibility, then review state, dependency, API, and test cohesion before adding more code

## review-trigger SIZE001 — `crates/arcweft-lang-sema/src/final_analysis/analyzer/calls.rs`

4314 physical LOC exceeds the 2500 LOC upper ownership-review trigger; LOC alone is not a structural error
...
4988 physical LOC exceeds the 2500 LOC upper ownership-review trigger; LOC alone is not a structural error

**Disposition:** record the named owner and cohesive responsibility, then either decompose along state/dependency/test boundaries or add an explicit repository-visible cohesion justification

## review-trigger TEST001 — `crates/arcweft-lang-sema/src/final_analysis/analyzer/calls/constraints.rs`

large maintained owner contains 531 physical LOC of embedded test module source; source layout alone is not a blocking test-coupling finding

**Disposition:** review whether tests follow the same responsibility boundary; move them only when that ownership review identifies real coupling

## review-trigger SIZE001 — `crates/arcweft-lang-sema/src/final_analysis/analyzer/dialogue_line_plan.rs`

1662 physical LOC exceeds the 1200 LOC ownership-review trigger
...
1889 physical LOC exceeds the 1200 LOC ownership-review trigger

**Disposition:** name the owner and responsibility, then review state, dependency, API, and test cohesion before adding more code

## review-trigger SIZE001 — `crates/arcweft-lang-sema/src/final_analysis/analyzer/expressions.rs`

3990 physical LOC exceeds the 2500 LOC upper ownership-review trigger; LOC alone is not a structural error
...
## review-trigger SIZE001 — `crates/arcweft-lang-sema/src/final_analysis/analyzer/patterns.rs`
...
1458 physical LOC exceeds the 1200 LOC ownership-review trigger

**Disposition:** name the owner and responsibility, then review state, dependency, API, and test cohesion before adding more code

## review-trigger SIZE001 — `crates/arcweft-lang-sema/src/final_analysis/model.rs`

2774 physical LOC exceeds the 2500 LOC upper ownership-review trigger; LOC alone is not a structural error

**Disposition:** record the named owner and cohesive responsibility, then either decompose along state/dependency/test boundaries or add an explicit repository-visible cohesion justification

## review-trigger SIZE001 — `crates/arcweft-lang-sema/src/final_analysis/nominal_schema.rs`

2947 physical LOC exceeds the 2500 LOC upper ownership-review trigger; LOC alone is not a structural error

**Disposition:** record the named owner and cohesive responsibility, then either decompose along state/dependency/test boundaries or add an explicit repository-visible cohesion justification

## review-trigger SIZE001 — `crates/arcweft-lang-sema/src/final_analysis/prepared.rs`

1647 physical LOC exceeds the 1200 LOC ownership-review trigger

**Disposition:** name the owner and responsibility, then review state, dependency, API, and test cohesion before adding more code

## review-trigger SIZE001 — `crates/arcweft-lang-sema/src/final_analysis/report.rs`

2230 physical LOC exceeds the 1200 LOC ownership-review trigger
...
8983 physical LOC exceeds the 8000 LOC upper ownership-review trigger; LOC alone is not a structural error
...
2223 physical LOC exceeds the 1200 LOC ownership-review trigger

**Disposition:** name the owner and responsibility, then review state, dependency, API, and test cohesion before adding more code

## review-trigger TEST001 — `crates/arcweft-lang-sema/src/ownership.rs`

large maintained owner contains 271 physical LOC of embedded test module source; source layout alone is not a blocking test-coupling finding
...
1709 physical LOC exceeds the 1200 LOC ownership-review trigger
...
1735 physical LOC exceeds the 1200 LOC ownership-review trigger
...
3881 physical LOC exceeds the 2500 LOC ownership-review trigger
...
2016 physical LOC exceeds the 1200 LOC ownership-review trigger

**Disposition:** name the owner and responsibility, then review state, dependency, API, and test cohesion before adding more code

## review-trigger SIZE001 — `crates/arcweft-runtime-plan/src/awbc_lower/flow.rs`

3230 physical LOC exceeds the 2500 LOC upper ownership-review trigger; LOC alone is not a structural error

**Disposition:** record the named owner and cohesive responsibility, then either decompose along state/dependency/test boundaries or add an explicit repository-visible cohesion justification

## review-trigger SIZE001 — `crates/arcweft-runtime-plan/src/awbc_lower/inventory.rs`

2161 physical LOC exceeds the 1200 LOC ownership-review trigger

**Disposition:** name the owner and responsibility, then review state, dependency, API, and test cohesion before adding more code

## review-trigger SIZE001 — `crates/arcweft-runtime-plan/src/final_expr.rs`

2542 physical LOC exceeds the 2500 LOC upper ownership-review trigger; LOC alone is not a structural error

**Disposition:** record the named owner and cohesive responsibility, then either decompose along state/dependency/test boundaries or add an explicit repository-visible cohesion justification

## review-trigger SIZE001 — `crates/arcweft-runtime-plan/src/final_flow.rs`

7076 physical LOC exceeds the 2500 LOC upper ownership-review trigger; LOC alone is not a structural error
...
10319 physical LOC exceeds the 2500 LOC upper ownership-review trigger; LOC alone is not a structural error

**Disposition:** record the named owner and cohesive responsibility, then either decompose along state/dependency/test boundaries or add an explicit repository-visible cohesion justification

## review-trigger SIZE001 — `crates/arcweft-runtime-plan/src/semantic_facts/project_function.rs`

2358 physical LOC exceeds the 1200 LOC ownership-review trigger

...
1971 physical LOC exceeds the 1200 LOC review threshold
...
5351 physical LOC exceeds the 2500 LOC review threshold
...
2479 physical LOC exceeds the 1200 LOC review threshold
...
2206 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-lang-sema/src/diagnostics.rs`

1231 physical LOC exceeds the 1200 LOC review threshold
...
2030 physical LOC exceeds the 1200 LOC review threshold
...
1637 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE002 — `crates/arcweft-verify-lsp/src/lib.rs`

facade file has 1637 physical LOC; target is below 250 LOC
...
1917 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE002 — `crates/arcweft-verify/src/lib.rs`

facade file has 1917 physical LOC; target is below 250 LOC

...
2882 physical LOC exceeds the 2500 LOC review threshold
...
1548 physical LOC exceeds the 1200 LOC review threshold
...
2466 physical LOC exceeds the 1200 LOC review threshold

**Fix:** review responsibility boundaries before adding more code

## warning SIZE001 — `crates/arcweft-runtime-plan/src/flow.rs`

2492 physical LOC exceeds the 1200 LOC review threshold

...
2080 physical LOC exceeds the 1200 LOC ownership-review trigger

**Disposition:** name the owner and responsibility, then review state, dependency, API, and test cohesion before adding more code

## review-trigger TEST001 — `crates/arcweft-bundle/src/resource_codec/runtime.rs`

large maintained owner contains 60 physical LOC of embedded test module source; source layout alone is not a blocking test-coupling finding
...
2102 physical LOC exceeds the 1200 LOC ownership-review trigger

**Disposition:** name the owner and responsibility, then review state, dependency, API, and test cohesion before adding more code

## review-trigger SIZE001 — `crates/arcweft-lang-sema/src/final_analysis/analyzer/expressions.rs`

2603 physical LOC exceeds the 2500 LOC upper ownership-review trigger; LOC alone is not a structural error
...
5654 physical LOC exceeds the 2500 LOC ownership-review trigger

**Disposition:** name the owner and responsibility, then review state, dependency, API, and test cohesion before adding more code

## review-trigger SIZE001 — `crates/arcweft-lang-sema/src/final_analysis/validation.rs`

2316 physical LOC exceeds the 1200 LOC ownership-review trigger

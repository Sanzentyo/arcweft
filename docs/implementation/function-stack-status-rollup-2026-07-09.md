...
- Semantic `Function` types now carry `EffectRow` values. Known
  ...
  function values preserve those rows, and source labels render closed
  non-empty rows.

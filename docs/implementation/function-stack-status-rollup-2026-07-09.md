...
- Spread partial/fallback shapes are intentionally rejected until their runtime
  ...
  is verified for exact, partial-prefix, and curried function application.
...
| --- | --- | --- |
| Spread partial application and spread data-last fallback | Fixed partial/fallback paths are implemented; spread shapes are rejected with diagnostics. Low-level runtime `Apply` spread expansion is verified, but accepted source-level spread mapping semantics are not designed. | `docs/reviews/requests/2026-07-07-seq-07.2.1-function-stack-spread-partial-and-fallback-contract.md`; `docs/implementation/function-stack-apply-spread-runtime-substrate-2026-07-09.md` |

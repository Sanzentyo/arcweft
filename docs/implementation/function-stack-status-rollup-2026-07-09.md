...
- Source-local wrapper functions that exact-call unaccepted source-local
  ...
  runtime-plan lowering rejects their missing-input partial construction and
  bare value references with the existing unsupported callable families.

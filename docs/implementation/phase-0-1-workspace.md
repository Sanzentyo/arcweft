...
- List expressions such as `[normal, smile, worried]`, `[]`, and nested call arguments parse as structured `Expr::List` nodes and participate in symbol collection and minimal type checking.
